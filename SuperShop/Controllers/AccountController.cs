    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    Response response = _mailHelper.SendEmail(model.Username, "Email Confirmation",
                         $"<h1>Email Confirmation</h1>" + $"To allow the user, " +
                         $"please click in this link: </br></br><a href = \"{tokenLink}\">Confirm Email</a>");

                    if (response.IsSuccess)
                    {
                        ViewBag.Message = "A confirmation email has been sent, please verify your inbox";
                        return View(model);
                    }
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                Response response = _mailHelper.SendEmail(model.Email, "Shop Password Reset", $"<h1>Shop Password Reset</h1></br>" +
